// Custom SVG Icons — zero dependencies, just inline SVGs wrapped as React components.
// All icons follow the same API: <IconName size={n} className="..." />
...
export const IndianRupee = (props) => (
  <Icon {...props}>
    ...
    <path d="M14 8a4 4 0 0 1 -4 4H6l8 9" />
  </Icon>
);
